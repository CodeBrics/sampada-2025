...
- Found Cryptographic Functions:
  * RAND_bytes((unsigned char*)&csbId, sizeof(csbId)) != 0, [1;31;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key failed|%s:%d|%s(), [1;33;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key,the ret %d|%s:%d|%s(), RSA_private_decrypt, RSA_public_encrypt

- Weak Encryption Detected:
  * DES-CFB1, EAP-MD5: Response, RC4(128), RC4438GpioIrqHandle, EAP-MD5: Generating Challenge Response

- Found Hardcoded Base64 Keys:
  * IHRoZSBiYXNoLWRvYyBwYWNrYWdlLgppZiBbIC1mIH4vLmJhc2hfYWxpYXNlcyBdOyB0aGVuCiAg
...
- **Current Date**: `Friday, January 31, 2025, 4 PM `
