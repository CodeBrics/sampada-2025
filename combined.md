...
- Found Cryptographic Functions:
  * [1;33;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key,the ret %d|%s:%d|%s(), [1;31;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key failed|%s:%d|%s(), RSA_private_decrypt, RSA_public_encrypt, RAND_bytes(m_tgk_ptr, tgkLengthValue) != 0

- Weak Encryption Detected:
  * EXP-DHE-RSA-DES-CBC-SHA, TCPMD5Unexpected, DES-EDE-OFB, WPA: RC4 key data too long (%lu), RC4438Enable

- Found Hardcoded Base64 Keys:
  * ZXJuYXRpb25hbDELMAkGA1UEBhMCSEsxEDAOBgNVBAgMB0tvd2xvb24xEDAOBgNV
