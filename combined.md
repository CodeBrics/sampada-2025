...
- Found Cryptographic Functions:
  * [1;31;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key failed|%s:%d|%s(), [1;33;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key,the ret %d|%s:%d|%s(), RSA_public_encrypt, RSA_private_decrypt, RAND_bytes(m_rand_data, m_rand_length) != 0

- Weak Encryption Detected:
  * MD5-SHA1, ssl_mac_secret_size[SSL_MD_SHA1_IDX] >= 0, pbeWithSHA1And40BitRC4, DESC, MD5-sess

- Found Hardcoded Base64 Keys:
  * dG8nCiAgICBhbGlhcyBkaXI9J2RpciAtLWNvbG9yPWF1dG8nCiAgICBhbGlhcyB2ZGlyPSd2ZGly
