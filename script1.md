...
- Found Cryptographic Functions:
  * RAND_bytes((unsigned char*)&csbId, sizeof(csbId)) != 0, RSA_private_decrypt, RSA_public_encrypt, RAND_bytes(m_tgk_ptr, tgkLengthValue) != 0, [1;33;40m%02d:%02d:%02d|SecurityUnit-454744|AES_set_encrypt_key,the ret %d|%s:%d|%s()

- Weak Encryption Detected:
  * PBE-SHA1-DES, SNIFFERDESTIP, ecdsa-with-SHA1, PBE-MD5-RC2-64, 6TCP: MD5 Hash failed for (%pI4, %d)->(%pI4, %d)%s

- Found Hardcoded Base64 Keys:
  * /usr/data/Data/storagePage/checkRegularDisableSelect
